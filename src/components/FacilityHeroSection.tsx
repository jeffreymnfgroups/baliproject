// src/components/FacilityHeroSection.tsx
...
const FacilityHeroSection: React.FC = () => {
  ...
  const heroWords = facilitySections.map(section => section.name.toUpperCase());
  let currentIndex = 0;
